...
<%@attribute name="page" type="org.agile4j.common.utils.page.Page" required="true" description="分页" %>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>

<table>
  <tr>
    <td>
    	<span class="page" >[共有记录${page.totalCount}条  / 共分${page.totalPage}页  ， 当前是第 ${page.nowPage} 页]</span>
	</td>
  </tr>
  <tr>
    <td>
